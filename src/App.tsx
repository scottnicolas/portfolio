    ...
    <section id="about" className="bg-black text-white py-16 md:px-8 lg:px-16">
      ...
      <div className="max-w-screen-xl mx-auto">
        <p className="flex items-center font-dm-sans-serif text-base md:text-xl text-left pt-4 pr-4 pb-4 pl-0">
          I’m a passionate frontend developer and designer with a strong
          foundation in building modern, user-friendly web applications. Skilled
          in React, TypeScript, and TailwindCSS, I have a keen eye for design
          and a commitment to creating seamless digital experiences.
        </p>
        <p className="flex items-center font-dm-sans-serif text-base md:text-xl text-left pt-4 pr-4 pb-4 pl-0">
          With a background in Computer Science and hands-on experience in
          developing full-stack applications, I enjoy turning ideas into
          functional, visually appealing products. I’m always eager to learn,
          innovate, and collaborate on projects that make a difference.
        </p>
      </div>
    </section>
    ...
    <section id="skills" className="bg-white py-16 px-4 md:px-8">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-3">
          <div className="border border-black rounded-xl shadow-lg p-5 mx-5">
          ...
          <div className="border border-black rounded-xl shadow-md p-5 mx-5">
